...
import me.crazyjiang.crazymusic.BuildConfig;
import me.crazyjiang.crazymusic.common.Constant;
import me.crazyjiang.crazymusic.di.qualifier.ServiceType;
import me.crazyjiang.crazymusic.model.http.api.BaiduApi;
import me.crazyjiang.crazymusic.util.FileUtil;
import me.crazyjiang.crazymusic.util.PhoneUtil;
...
public class HttpModule {
    ...
    @Provides
    @ServiceType("Baidu")
    Retrofit provideBaiduRetrofit(Retrofit.Builder builder, OkHttpClient client) {
        return createRetrofit(builder, client, BaiduApi.HOST);
    }

    @Singleton
    @Provides
    BaiduApi provideBaiduService(@ServiceType("Baidu") Retrofit retrofit) {
